...
| 📄 [Netflix Credential Harvesting & Link-Based Phishing Campaign](./SOC-Report-2026-09-19-Netflix-Credential-Harvesting-Link-Phishing.md) | Forensic analysis of a Netflix billing-alert phishing email using HTTP 404 cloaking and Tor exit-node filtering to evade automated scanners. Includes live anonymized testing via Tor Browser. | Threat Intelligence & Anti-Analysis Evasion |
